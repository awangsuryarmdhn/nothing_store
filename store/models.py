...
class Order(models.Model):
    ...
    first_name = models.CharField("Nama Lengkap", max_length=50)
    last_name = models.CharField("Nama Belakang", max_length=50, blank=True, null=True)
    email = models.EmailField("Email")
    address = models.CharField("Alamat Lengkap", max_length=250)
    postal_code = models.CharField("Kode Pos", max_length=20, blank=True, null=True)
    city = models.CharField("Kota", max_length=100)
